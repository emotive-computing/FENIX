...
% Pearson 
% -------------------------------------------------------------------------
figtitle= ('F101_FT_pipe1_nsnw_fnirs_fmri'); create_figure(figtitle);
...
% Pearson 
% -------------------------------------------------------------------------
figtitle= ('F101_FT_pipe2_nsnw_fnirs_fmri'); create_figure(figtitle);
X1 = F101_FT_roi(1:308,:); % crop to fit fnirs time-series (omit last fixation)
Y1 = F101_hbo;
[r1, p1, Tstat] = correlation_fast_series(X1, Y1);
...
% Pearson 
% -------------------------------------------------------------------------
figtitle= ('F101_FT_pipe3_nsnw_fnirs_fmri'); create_figure(figtitle);
X1 = F101_FT_roi(1:308,:); % crop to fit fnirs time-series (omit last fixation)
Y1 = F101_hbo;
[r1, p1, Tstat] = correlation_fast_series(X1, Y1);
