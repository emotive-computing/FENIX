%% This script runs correlations between FMRI and FNIRS time-series per subject 

% (1) Pearson corrs 
% /Applications/Canlab/CanlabCore/CanlabCore/Statistics_tools/correlation_fast_series.m

% (2) Time-lagged corrs 
% /Applications/MATLAB_R2022a.app/toolbox/matlab/datafun/xcorr.m
...
% TODO 
% ADD time-lagged corrs using matlab's native xcorr function 
% replication of Liu 2015 - -- see FENIX_notes googledoc 
