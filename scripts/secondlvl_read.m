...
resultsdir = fullfile(basedir, 'results_reading');
figsavedir = fullfile(resultsdir, 'figures');

% 2nd level
% ------------------------------------------------------------------------

prep_1_reading_set_conditions_contrasts_colors
...
% better dorsal axial view to match reading studies

% READING NEUTRAL 
o2 = fmridisplay
r = region(contrast_t_unc{1}, 'noverbose');
o2 = montage(o2, 'sagittal', 'slice_range', [-60 -20], 'spacing',2, 'noverbose');
o2 = addblobs(o2, r, 'splitcolor', {[0 0 1] [0 1 1] [1 .5 0] [1 1 0]}, 'noverbose'); 
o2 = legend(o2);

figtitle = ['read_neutral_01unc_sag.png'];
...
figtitle = ['read_affect_01unc_sag.png'];
savename = fullfile(figsavedir,figtitle);saveas(gcf,savename); drawnow, snapnow; %close;
clear o2
...
figtitle = ['read_affect_min_neut_01unc_sag.png'];
savename = fullfile(figsavedir,figtitle);saveas(gcf,savename); drawnow, snapnow; %close;
clear o2
